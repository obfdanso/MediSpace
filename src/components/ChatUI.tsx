...
export default function ChatUI() {
  const [messages, setMessages] = useState<Message[]>([
    { id: "1", role: "ai", content: "Hello! Ask me about any medication." }
  ]);
  ...
  return (
    <div className="flex flex-col w-full h-full bg-transparent overflow-hidden">
      {/* Chat Header */}
      <div className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-6 py-4 flex items-center gap-3 shrink-0">
